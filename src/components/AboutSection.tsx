          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-7">
              <h2 className="text-2xl md:text-5xl font-light leading-tight tracking-tight mb-8 md:mb-12">
                AJ Academy cultivates leadership as an <span className="font-medium text-orange-500 underline underline-offset-8 decoration-orange-500/30">intuitive process</span>—reaching beyond strategy to the core of human purpose.
              </h2>
              
              <div className="h-[1px] w-20 md:w-24 bg-orange-500/40 mb-8 md:mb-12" />

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 text-white/70">
                <p className="text-base md:text-lg leading-relaxed font-light">
                  We believe in mastering the <span className="text-orange-500 font-normal">internal landscape</span> first. True leadership is the external manifestation of internal clarity and self-mastery.
                </p>
                <p className="text-base md:text-lg leading-relaxed font-light">
            ...
            <div className="lg:col-span-4 lg:col-start-9 border-t lg:border-t-0 lg:border-l border-white/10 pt-10 lg:pt-4 lg:pl-8">
              <div className="space-y-6 md:space-y-8">
                <div>
                  <p className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] text-orange-500/70 font-bold mb-2">
                    Established Standard
                  </p>
                  <p className="text-xl md:text-2xl font-light tracking-wide italic text-white">The AJ Excellence</p>
                </div>
                
                <div className="pt-4 md:pt-8">
                  <div className="inline-block p-5 md:p-6 border border-orange-500/20 bg-orange-500/5 backdrop-blur-sm">
                    <p className="text-xs md:text-sm font-light leading-relaxed italic text-orange-500">
